        ...
        <div className="absolute inset-0 bg-black/50">
          <div className="container mx-auto flex h-full flex-col items-center justify-center text-center text-white">
            ...
            <p className="mt-4 max-w-[700px] text-lg text-gray-200">
              Protect crop yield and increase farm profitability through sharing unbiased, science-based tracking and
      ...
      <section className="container mx-auto grid gap-12 pb-24 md:grid-cols-3">
        <div>
          ...
          <p className="mt-4 text-muted-foreground">
            To provide farmers and agricultural professionals with accurate, timely information for effective pest
        ...
        <div>
          ...
          <p className="mt-4 text-muted-foreground">
            Farmers, agronomists, researchers, and agricultural professionals seeking to monitor and manage crop pests
            effectively.
          </p>
        </div>
        <div>
          ...
          <p className="mt-4 text-muted-foreground">
            Interactive maps, forecasting tools, data visualization, and reporting systems for comprehensive pest
            monitoring.
          </p>
        </div>
      </section>
